    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix text-left pt-5">
                <h5>Edit <span class="semi-bold">Project Details</span></h5>
            </div>
                ...
                {{-- <form action="{{ route('events.update')}}" method="POST" enctype="multipart/form-data" name="events" id="events"> --}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Title</label>
                                <input type="text" value="{{$projects['title']}}" name="title" placeholder="title"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Field</label>
                                <input type="text" value="{{$projects['field']}}" name="field" placeholder=""
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Field 2</label>
                                <input type="text" value="{{$projects['field2']}}" name="field2" placeholder=""
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" value="{{$projects['location']}}" name="location" placeholder=""
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Flag</label>
                                <input type="text" value="{{$projects['flag']}}" name="flag" placeholder=""
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Date</label>
                                <input type="date" value="{{$projects['date']}}" name="date" placeholder="" class="form-control"
                                    >
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                class="form-control">{{$projects['about']}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label> Image</label>
                                <input type="file" id="file_path" value="{{$projects['file_path']}}" name="file_path" accept="image/*"
                                    class="form-control" >
                            </div>
                        </div>
                    </div> 
