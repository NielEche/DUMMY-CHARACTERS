...
@section('title')
Admin Dashboard | Edit Souncloud
@endsection
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix text-left pt-5">
                <h5>Edit <span class="semi-bold">Soundcloud Details</span></h5>
            </div>
            <div class="modal-body">
                <form action="/editsoundcloud" method="POST" enctype="multipart/form-data">
                    
                {{-- </form> --}}
                {{-- <form action="{{ route('events.update')}}" method="POST" enctype="multipart/form-data" name="events" id="events"> --}}
                    @csrf

                    <input type="hidden" name="id" value="{{$soundcloud['id']}}">

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Url</label>
                                <input type="text" value="{{$soundcloud['link']}}" name="link" placeholder="link"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
