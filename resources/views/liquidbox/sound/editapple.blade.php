    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix text-left pt-5">
                <h5>Edit <span class="semi-bold">Apple Details</span></h5>
            </div>
            <div class="modal-body">
                <form action="/editApple" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Url</label>
                                <input type="text" value="{{$apple['link']}}" name="link" placeholder="link"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
