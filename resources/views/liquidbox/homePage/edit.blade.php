...
@section('title')
Admin Dashboard | Edit Home Slider
@endsection
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix text-left pt-5">
                <h5>Edit <span class="semi-bold">Slider</span></h5>
            </div>
                ...
                {{-- <form action="{{ route('events.update')}}" method="POST" enctype="multipart/form-data" name="events" id="events"> --}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label> Image</label>
                                <input type="file" id="file_path" value="{{$sliders['file_path']}}" name="file_path" accept="image/*"
                                    class="form-control" >
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Caption</label>
                                <input type="text" value="{{$sliders['headtext']}}" name="headtext" placeholder="{{$sliders['headtext']}}"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 m-t-10">
                            <button value="submit"
                                class="btn btn-primary btn-block m-t-5"> <a class="text-white" href="{{ route('home.index') }}">Cancel</a></button>
                        </div>
