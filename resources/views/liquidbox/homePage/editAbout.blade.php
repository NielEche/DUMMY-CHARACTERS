                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>About</label>
                                <textarea rows="10" type="text" value="{{$abouts['about_text']}}" name="about_text"
                                    placeholder="About "
                                    class="form-control">{{$abouts['about_text']}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 m-t-10">
                            <button value="submit" class="btn btn-primary btn-block m-t-5"> <a class="text-white"
                                    href="{{ route('home.index') }}">Cancel</a></button>
                        </div>
