...
<script>
  ...
  gtag('config', 'UA-51772907-1');
        ...
        <link rel="apple-touch-icon" href="{{ asset('files/favicons/favicon.ico') }}">
		<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('files/favicons/favicon.ico') }}">
		<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('files/favicons/favicon.ico') }}">
		<link rel="apple-touch-icon" sizes="152x152" href="{{ asset('files/favicons/favicon.ico') }}">
        <link rel="icon" type="image/x-icon" href="{{ asset('files/favicons/favicon.ico') }}" />
    ...
    <body class="fixed-header dashboard windows desktop pace-done sidebar-visible menu-pin">
            <!-- Page Heading -->
            @include('liquidbox.partials.header')
            ...
            @include('liquidbox.partials.scripts')
    </body>
</html>
